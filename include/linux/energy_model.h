				...
				unsigned long max_util, unsigned long sum_util)
{
	...
	/* Apply the exact same headroom margin as schedutil */
	...
	for (i = 0; i < pd->nr_cap_states; i++) {
		...
		/* Calculate capacity of this OPP */
		cs_cap = (cs->frequency * scale_cpu) / max_freq;

		/*
		 * If this OPP provides enough capacity for the scaled
		 * utilization, this is the frequency schedutil would select.
		 */
